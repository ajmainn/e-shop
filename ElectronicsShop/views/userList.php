...
// $sql = "SELECT id, fullName, address, phone, email, gender FROM user";
...
<body>
    ...
    <script>
        function fetchuserList() {
            ...
            xhr.open("GET", "http://localhost/ElectronicsShop/controllers/userController.php/get-alluser", true);
        ...
        function renderuserList(userList) {
            ...
            userList.forEach(function(user) {
                ...
                row.insertCell().textContent = user.approval_status === "1" ? "Approved" : "Not Approved";
                ...
                changeStatusButton.addEventListener("click", function() {
                    changeApprovalStatus(user.id, user.approval_status);
                });
        ...
        function changeApprovalStatus(userId, approval_status) {
            // Create a new XMLHttpRequest object
            var xhr = new XMLHttpRequest();

            // Configure the request
            xhr.open('POST', '../controllers/userController.php/change-status', true);
