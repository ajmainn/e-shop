...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../view/Color.css">
...
<td>
	<fieldset>
		<br>
    <p align='center'><b>Username: <?php echo $username; ?></p><br>
    <p align='center'>Address: <?php echo $address; ?></p><br>
    <p align='center'>Contact: <?php echo $contact; ?></p><br>
    <p align='center'>Email: <?php echo $email; ?></p><br>
</td>
</tr>
</fieldset>
<table>
