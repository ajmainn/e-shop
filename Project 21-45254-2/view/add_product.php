...
<body>
    ...
    <form action="process_add_menu.php" method="post" novalidate  onsubmit="return  validatemenuForm(this);">
      <table align='center'>
        <tr>
            <td>
                <fieldset>
        ...
        <br>
        <p align='center'><input type="button" value="Add Product" onclick="postMenuData()"></p><br>
