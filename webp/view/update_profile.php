...
<form action="process_update_profile.php" method="post" novalidate onsubmit="return  validateupdate_profileForm(this);">
    <table align='center'>
        <tr>
            <td>
               <fieldset>
      ...
      <br> <p align='center'>  <?php echo "<a href='profile.php'><b>Go back</b></a>"?><br></p>
      <br> <p align='center'>  <?php echo "<a href='welcome.php'><b>Back to Main page</b></a>"?></p>
