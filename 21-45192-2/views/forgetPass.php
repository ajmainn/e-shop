...
<head>
    ...
    <script src ="../assets/forgetPass.js" ></script>
    <title>Forgot Password</title>
    <link rel="stylesheet" type="text/css" href="../assets/signup.css">
</head>
<body>
<form action="../controllers/forgetPassController.php" method="post" novalidate onsubmit="return validateforgetPassForm(this);">
<table align="center">
    <tr>
        <td>
    <fieldset>
