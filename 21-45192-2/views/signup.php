...
<body>
    ...
    <p align="center">Last modified on: <?php echo $displayTime; ?></p><br>
    <form action="../controllers/signupController.php" method="post" novalidate onsubmit="return validateSignupForm(this);">
   <table  align="center">
...
<tr>
    <td>
        ...
        <span id="fullName" class="error-message"></span>
        <br>
